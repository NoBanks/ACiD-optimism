...
contract AnchorStateRegistry is ProxyAdminOwnedBase, Initializable, ReinitializableBase, ISemver {
    ...
    function setAnchorState(IDisputeGame _game) public {
        // Convert game to FaultDisputeGameV2.
        // We can't use FaultDisputeGameV2 in the interface because this function is called from the
        // FaultDisputeGameV2 contract which can't import IFaultDisputeGameV2 by convention. We should
